...
distributed under the terms of version 2 of the GNU general
public license (GPL).
...
1. DeuTex incorporates code derived from DEU 5.21. DEU 5.21 was
   put in the public domain in 1994 by Raphaël Quinet and Brendon
   Wyber. No part of DeuTex is public-domain, however.

2. The file lzw.c contains the following notes :
...
3. The files endianio.c and endianm.c are Copyright © André Majorel 1999
